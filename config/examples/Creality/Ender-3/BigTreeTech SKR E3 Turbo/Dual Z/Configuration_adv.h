...
#define Z_STEPPER_AUTO_ALIGN
   ...
   */
  #define Z_STEPPER_ALIGN_XY { { 15, 118}, { 210, 118}}
   ...
   * driver order.
   */
  //#define Z_STEPPER_ALIGN_STEPPER_XY { { 15, 118}, { 220, 118}}
...
#define LIN_ADVANCE
    ...
    #define ADVANCE_K { 0.07 }     // (mm) Compression length per 1mm/s extruder speed, per extruder
  #else
